#ifndef PARTIALRUN_API_INTERNAL_H_
#define PARTIALRUN_API_INTERNAL_H_
...
bool        isTechDisabledByDummyMode           (PartialRun::PRTechType techType);
  ...
  * @param  - category: IF category defined in json file (example: see in ME.Develop/utilities/vehicles/duplications/vdPedsRelationsIF.h.VDPedsRelationCollectionIF.json),
